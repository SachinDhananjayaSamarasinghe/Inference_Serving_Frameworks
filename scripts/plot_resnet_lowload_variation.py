...
csv_files = sorted(glob.glob("gpu_metrics_resnet_run*.csv"))
...
plt.xticks(x, labels)
plt.title("ResNet50 Low Load - Power Variation Across 3 Runs")
plt.ylabel("Power (Watts)")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("resnet_lowload_variation.png")
plt.show()
