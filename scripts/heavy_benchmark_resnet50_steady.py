# Steady Load Benchmark Script (ResNet50)
# Sends all requests as fast as possible
...
# Save latency log
with open("resnet_latency_steady.csv", "w", newline='') as f:
    writer = csv.writer(f)
...
print(" Steady Load Benchmark Completed!")
