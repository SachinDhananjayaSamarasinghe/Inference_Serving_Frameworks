...
# Load the burstload CSVs
csv_files = sorted(glob.glob("gpu_metrics_mobilenet_burst_run*.csv"))
...
plt.xticks(x, labels)
plt.title("MobileNet Burst Load - Power Variation Across 3 Runs")
plt.ylabel("Power (Watts)")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("mobilenet_burstload_variation.png")
plt.show()
